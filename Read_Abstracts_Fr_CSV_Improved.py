...
counter_2011, num_pats_2011=parse_abstracts(name+'Abstracts_csv_2011.csv')
counter_2012, num_pats_2012=parse_abstracts(name+'Abstracts_csv_2012.csv')
counter_2014, num_pats_2014=parse_abstracts(name+'Abstracts_csv_2014.csv')
counter_2015, num_pats_2015=parse_abstracts(name+'Abstracts_csv_2015.csv')
